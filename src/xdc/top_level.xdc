...
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {clk_100mhz_raw}]
create_clock -add -name gclk -period 10.000 -waveform {0 4} [get_ports {clk_100mhz_raw}]
